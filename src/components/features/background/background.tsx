...
export function ColorBends({
  ...
  useEffect(() => {
    ...
    const handlePointerMove = (e: PointerEvent) => {
      // Since the container is fixed full-screen, we can use window dimensions
      // or client coordinates directly to determine normalized position.
      // Using window dimensions is simpler if we assume full screen.
